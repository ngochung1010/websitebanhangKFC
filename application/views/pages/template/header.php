...
<head>
    ...
    <title><?php $this->config->config["pageTitle"] ?></title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> (028) 38489828</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> lienhe@kfcvietnam.com.vn</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="logo pull-left">
							<a href="index.html">
							<img src="<?php echo base_url('uploads/hinhanh/logo1.jpg') ?>" width="100" height="100" alt="">
							</a>
						</div>
					...
					<div class="col-sm-9">
						<div class="row">
							<div class="shop-menu pull-right">
								<ul class="nav navbar-nav">	
									<?php
									if($this->session->userdata('LoggedInKhachHang')){
									?>
									<li><a href="#"><i class="fa fa-user"></i> Tài Khoản: <?php echo $this->session->userdata('LoggedInKhachHang')['username'] ?></a></li>
					...
					<div class="col-sm-5">
						<div class="search_box pull-right">
							<form action="<?php echo base_url('tim-kiem') ?>" method="GET">
								<input type="text" name="keyword" placeholder="Tìm Kiếm Món Ăn..."/>
								<input type="submit" style="margin:0" value="Tìm Kiếm" class="btn btn-default add-to-cart"/>
